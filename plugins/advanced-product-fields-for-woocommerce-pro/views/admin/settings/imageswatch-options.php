...
<div class="wapf-field__setting" data-setting="<?php echo $model['id']; ?>">
    ...
    <div class="wapf-setting__input wapf-setting-imaswatch-options">
        <table style="width: 100%;" rv-show="field.choices | isNotEmpty">
            <thead>
            <tr>
                <td style="width:20px;"></td>
                <td style="font-weight:500;text-align: left;width:85px;"><?php _e('Image','sw-wapf'); ?></td>
                <td style="font-weight:500;text-align: left;"><?php _e('Option label','sw-wapf'); ?></td>
            ...
            <tr rv-each-choice="field.choices" rv-data-option-slug="choice.slug">
                ...
                <td>
                    <div class="wapf-media-selector">
                        ...
                        <div class="wapf-media-preview" rv-class-wapf-hide="choice.image | isEmpty">
                            <a class="wapf-btn-add-media"><img rv-src="choice.image" /></a>
                        </div>
